        ...
        new Thread(){
            public void run() {
                ...
                try{
                    ...
                    link = getHTML("http://ec2-54-210-37-207.compute-1.amazonaws.com/getProducts/AkshayMata");
                }catch(Exception e){
                ...
                for (int i=0; i<tokens.length;i++){
                    ...
                    if(tokens_content.length==12){
                        arrayClothing.add(new Clothing(tokens_content[1],tokens_content[2],tokens_content[3],tokens_content[4],tokens_content[5],tokens_content[6],tokens_content[7],tokens_content[8],tokens_content[9],tokens_content[10],tokens_content[11]));
